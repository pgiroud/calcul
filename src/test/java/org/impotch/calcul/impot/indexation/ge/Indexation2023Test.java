...
public class Indexation2023Test {
    ...
    public void indexationMontantMinimalDeLaDepense() {
        ...
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2016); // Voir loi 11683
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(400_000), ANNEE)).isEqualTo(BigDecimal.valueOf(404_651));
    }

    private void trouverAnnee(FournisseurIndexGenevois fournisseur) {
        BigDecimal valeurAttendue = BigDecimal.valueOf(5029).divide(BigDecimal.valueOf(5000),10,RoundingMode.HALF_UP);
        for (int i = 2009; i < 2024; i++) {
            for (int j = i; j < 2024; j++) {
                BigDecimal rapport = fournisseur.getFournisseurIndiceGEBaseDecembre2005().getIndice(j)
                        .divide(fournisseur.getFournisseurIndiceGEBaseDecembre2005().getIndice(i), 10, RoundingMode.HALF_UP);
                if (valeurAttendue.subtract(rapport).abs().compareTo(new BigDecimal("0.001")) < 0) {
    ...
    public void montantMaxExonerationSoldeSapeurPompier() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2014); // Voir lois 10905, 12884
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(9_000), ANNEE)).isEqualTo(BigDecimal.valueOf(9_052));
    }
    ...
    public void plancherFraisForfaitaire() {
        ...
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(600), ANNEE)).isEqualTo(BigDecimal.valueOf(609));
    }
    ...
    public void plafondFraisForfaitaire() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(1700), ANNEE)).isEqualTo(BigDecimal.valueOf(1725));
    }
    ...
    public void deductionPrevoyancePourEpouxVivantEnMenageCommun() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(3300), ANNEE)).isEqualTo(BigDecimal.valueOf(3348));
    }
    ...
    public void deductionPrevoyancePourContribuableSeul() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(2200), ANNEE)).isEqualTo(BigDecimal.valueOf(2232));
    }
    ...
    public void deductionPrevoyanceParCharge() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(900), ANNEE)).isEqualTo(BigDecimal.valueOf(913));
    }
    ...
    public void deductionPrevoyanceParChargeQuandUnSeulDesMembresDuCoupleCotise() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(1350), ANNEE)).isEqualTo(BigDecimal.valueOf(1370));
    }
    ...
    public void deductionFraisGardeEnfants() {
        ...
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2019);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(25000), ANNEE)).isEqualTo(BigDecimal.valueOf(25048));
    }
    ...
    public void deductionDoubleActivite() {
        ...
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2021);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(1000), ANNEE)).isEqualTo(BigDecimal.valueOf(1000));
    }
    ...
    public void plafondGainsDeLoterie() {
        ...
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2014);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(5000), ANNEE)).isEqualTo(BigDecimal.valueOf(5029));
    ...
    public void plafondFraisProfessionnelsFormation() {
        ...
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2016);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(12_000), ANNEE)).isEqualTo(BigDecimal.valueOf(12_140));
    }
    @Test
    ...
    public void deductionSocialesChargesFamilles() {
        ...
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2021);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(13_000), ANNEE)).isEqualTo(BigDecimal.valueOf(13_000));
    }
    ...
    public void deductionSocialesChargesFamillesSiFraisDeGarde() {
        ...
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2021);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(10_000), ANNEE)).isEqualTo(BigDecimal.valueOf(10_000));
    }
    ...
    public void deductionSocialesDemiChargesFamilles() {
        ...
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2021);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(6500), ANNEE)).isEqualTo(BigDecimal.valueOf(6500));
    }
    ...
    public void deductionSocialesDemiChargesFamillesSiFraisDeGarde() {
        ...
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2021);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(5000), ANNEE)).isEqualTo(BigDecimal.valueOf(5000));
    }
    ...
    public void revenuMaximalAnnuelEnfantMineurParCharge() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(15_333), ANNEE)).isEqualTo(BigDecimal.valueOf(15_557));
    }
    ...
    public void revenuMaximalAnnuelEnfantMineurParDemiCharge() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(23_000), ANNEE)).isEqualTo(BigDecimal.valueOf(23_335));
    }
    ...
    public void fortuneMaximaleEnfantMajeurJusqua25ansApprentiEtudiant() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(87_500), ANNEE)).isEqualTo(BigDecimal.valueOf(88_776));
    }
    ...
    public void deductionBeneficiairesRentesAVSouAICoupleAvecUnSeulRentier() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        BaremeParTranche baremeAdapte = indexateurBaseDec05.indexer(construireBaremeArt40Alinea1LIPPUnSeulRentier(),ANNEE);
    ...
    public void deductionBeneficiairesRentesAVSouAICoupleAvecDeuxRentiers() {
        ...
        BaremeParTranche baremeAdapte = indexateurBaseDec05.indexer(baremeLIPP2009,ANNEE);
        BaremeParTranche baremeAttendu = unBareme()
    ...
    public void valeurAPartirDeLaquelleLesBijouxEtLArgenterieEstImposable() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(2000), ANNEE)).isEqualTo(BigDecimal.valueOf(2029));
    }
    ...
    public void deductionsSocialesFortunePersonneSeule() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(82_200), ANNEE)).isEqualTo(BigDecimal.valueOf(83_398));
    }
    ...
    public void deductionsSocialesFortuneCouple() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(164_400), ANNEE)).isEqualTo(BigDecimal.valueOf(166_797));
    }
    ...
    public void deductionsSocialesFortuneParCharge() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(41_100), ANNEE)).isEqualTo(BigDecimal.valueOf(41_699));
    }
    ...
    public void deductionsSocialesFortuneIndependants() {
        FournisseurIndexGenevois fournisseur = new FournisseurIndexGenevoisEnMemoire();
        Indexateur indexateurBaseDec05 = fournisseur.getIndexateurQuadriennalBaseDecembre2005(2009);
        assertThat(indexateurBaseDec05.indexer(BigDecimal.valueOf(500_000), ANNEE)).isEqualTo(BigDecimal.valueOf(507_289));
    }
