...
public class ProducteurImpotDerivePourcent implements ProducteurImpotDerive {
	...
	/* (non-Javadoc)
	 * @see ch.ge.afc.calcul.impot.ProducteurImpotDerive#produireImpot(java.math.BigDecimal, ch.ge.afc.calcul.impot.FournisseurAssiette, ch.ge.afc.calcul.impot.RecepteurImpot)
	 */
	@Override
