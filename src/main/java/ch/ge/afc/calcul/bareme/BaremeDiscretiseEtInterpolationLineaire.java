...
public class BaremeDiscretiseEtInterpolationLineaire implements Bareme {
	...
	public BigDecimal calcul(BigDecimal assiette) {
		...
		if (0 < comparaisonAvecMax) throw new IllegalArgumentException("Il est impossible de calculer l'impÃ´t pour une assiette de " + assiette + " car le barÃ¨me s'arrÃªte Ã  " + assietteMaximumDansBareme);
